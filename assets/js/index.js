...
! function (t, n) {
    ...
    function e(t) {
        ...
        for (i = 1; i < arguments.length; i++) {
            var o = arguments[i] || {};
            for (n in o) s[n] = "object" == typeof s[n] ? e(s[n], o[n]) : s[n] || o[n]
        }
        return s
    }
    ...
    function o(t, n) {
        n = e(n, o.options), this.lastKnownScrollY = 0, this.elem = t, this.debouncer = new i(this.update.bind(this)), this.tolerance = s(n.tolerance), this.classes = n.classes, this.offset = n.offset, this.initialised = !1, this.onPin = n.onPin, this.onUnpin = n.onUnpin, this.onTop = n.onTop, this.onNotTop = n.onNotTop
    }
    var a = {
        bind: !! function () {}.bind,
    ...
    t.requestAnimationFrame = t.requestAnimationFrame || t.webkitRequestAnimationFrame || t.mozRequestAnimationFrame, i.prototype = {
        ...
        destroy: function () {
            var n = this.classes;
            this.initialised = !1, t.removeEventListener("scroll", this.debouncer, !1), this.elem.classList.remove(n.unpinned, n.pinned, n.top, n.initial)
        },
        attachEvent: function () {
            this.initialised || (this.lastKnownScrollY = this.getScrollY(), this.initialised = !0, t.addEventListener("scroll", this.debouncer, !1), this.debouncer.handleEvent())
        },
        unpin: function () {
        ...
        getScrollY: function () {
            return void 0 !== t.pageYOffset ? t.pageYOffset : (n.documentElement || n.body.parentNode || n.body).scrollTop
        },
    ...
    }, o.cutsTheMustard = "undefined" != typeof a && a.rAF && a.bind && a.classList, t.Headroom = o
}(window, document);
...
$(document).ready(function () {
    if (action == 'subscribe') {
        var loading = document.getElementById("subSucces");
...
function validateEmail(mail) {
    if (/^\w+([\.-]?\w+)*@\w+([\.-]?\w+)*(\.\w{2,3})+$/.test(mail)) {
        console.log('show confirm msg')
        var loading = document.getElementById("confirmMsg");
        loading.style.display = "block";
        return (true)
    } else {
        var loadingerror = document.getElementById("errorMsg");
...
function showSubscribeFunction() {

    document.getElementById('subscribeOverlay').style.display = 'block';
    let element = document.getElementById("pageBody");
    element.classList.add("noscroll");


}

function closeSubscribeFunction() {
